...
func main() {
	...
	bodyBuf, e = yaml.Marshal(payload)
	if e != nil {
		panic(e)
	}
	...
	fmt.Println(packet)
	//[0 0 0 42 0 0 0 1 0 0 0 14 0 0 0 16 123 34 97 117 116 104 34 58 34 97 98 99 34 125 117 115 101 114 95 110 97 109 101 58 32 116 99 112 120 10]
}
